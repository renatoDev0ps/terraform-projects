...
resource "aws_subnet" "subnet_public-1a" {
  ...
  tags = {
    Name = "SUBNET_WINPLACECORP | ZONE-1A | 192.168.1.0/24"
  }
}
...
resource "aws_subnet" "subnet_public-1b" {
  ...
  tags = {
    Name = "SUBNET_WINPLACECORP | ZONE-1B | 192.168.2.0/24"
  }
}
...
resource "aws_subnet" "subnet_public-1c" {
  ...
  tags = {
    Name = "SUBNET_WINPLACECORP | ZONE-1C | 192.168.3.0/24"
  }
}
...
resource "aws_subnet" "subnet_public-1d" {
  ...
  tags = {
    Name = "SUBNET_WINPLACECORP | ZONE-1D | 192.168.4.0/24"
  }
}