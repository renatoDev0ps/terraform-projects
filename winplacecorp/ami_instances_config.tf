...
resource "aws_instance" "frontend" {
  ...
  tags = {
    Name = "EC2-WinPlaceCorp_Frontend-Maq01"
  }
}
...
resource "aws_instance" "site" {
  ...
  tags = {
    Name = "EC2-WinPlaceCorp_Site-Maq01"
  }
}
...
resource "aws_instance" "application" {
  ...
  tags = {
    Name = "EC2-WinPlaceCorp_Application-Maq01"
  }
}
...
#   tags = {
#     Name = "EC2-WinPlaceCorp_Redis-Maq01"
#   }
# }
...
resource "aws_instance" "database" {
  ...
  tags = {
    Name = "EC2-WinPlaceCorp_Database-Maq01"
  }
}
...
resource "aws_instance" "bitcoincore" {
  ...
  tags = {
    Name = "EC2-WinPlaceCorp_BitcoinCore-Maq01"
  }
}
